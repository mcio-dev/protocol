...
Mojang 的版本指南越来越乱，特别是在高版本。所以高版本仅展示第一个版本的版本指南名称。
...
+ [26.1-26.1.2 protocol 775](https://minecraft.wiki/w/Java_Edition_protocol/Packets) 未存档

## 1.21 棘巧试炼

> 注: 可能是由于 wiki.vg 迁移到 Minecraft wiki 造成一些耽误，目前不存在 768 的协议文档，与 767 共用一个链接。

+ v1_21_R7 [1.21.11 protocol 774](https://minecraft.wiki/w/Java_Edition_protocol/Packets) 未存档
+ v1_21_R7,v1_21_R6 [1.21.10, 1.21.9 protocol 773](https://minecraft.wiki/w/Java_Edition_protocol/Packets) 未存档
+ v1_21_R5 [1.21.7-1.21.8 protocol 772](https://minecraft.wiki/w/Java_Edition_protocol/Packets?oldid=3258009) 未同步
