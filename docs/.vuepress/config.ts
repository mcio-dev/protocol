...
const DOMAIN_NAME = 'protocol.mcio.dev' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'mcio-dev/protocol', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        ...
        '<p>《我的世界》和《Minecraft》是微软公司和 Mojang Synergies AB 的商标，本站点与微软公司没有从属关系。</p>',
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '技术文档,人间工作P,人间工作,我的世界,服务器,多人游戏,插件,协议,kotlin,java,git,github,minecraft,mc,bukkit,spigotmc,spigot,papermc,paper,bungeecord,velocity,plugin,mod,fabric,forge,neoforge,neoforged,protocol',
      },
    ],
